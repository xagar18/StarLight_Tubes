...
export function CardSpotlightDemo({
  ...
  return (
    <CardSpotlight className="h-fit w-full rounded-3xl border border-white/10 shadow-2xl bg-linear-to-br from-gray-900 via-gray-900 to-gray-800 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        {heading && (
          <div className="mb-10 text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-teal-500/20 to-blue-500/20 border border-teal-500/30 mb-6">
              <span className="w-2 h-2 rounded-full bg-teal-400 animate-pulse"></span>
              <span className="text-teal-400 text-sm font-medium tracking-wide">
                Established Excellence
              </span>
            </div>
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold relative z-20 bg-linear-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent tracking-tight leading-tight">
              {heading}
            </h3>
            <div className="mt-4 flex gap-1 justify-center md:justify-start">
              <span className="w-12 h-1.5 bg-linear-to-r from-teal-400 to-teal-500 rounded-full"></span>
              <span className="w-6 h-1.5 bg-linear-to-r from-blue-400 to-blue-500 rounded-full"></span>
              <span className="w-3 h-1.5 bg-linear-to-r from-purple-400 to-purple-500 rounded-full"></span>
            </div>
          </div>
        )}
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          {image && (
            <div className="relative">
              {/* Image Glow Effect */}
              <div className="absolute inset-0 bg-linear-to-r from-teal-500/20 to-blue-500/20 rounded-2xl blur-xl scale-95"></div>

              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 group">
                {/* Image Overlay Gradient */}
                <div className="absolute inset-0 bg-linear-to-t from-gray-900/80 via-transparent to-transparent z-10 opacity-60 group-hover:opacity-40 transition-opacity duration-500"></div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="text-center">
                <div className="text-2xl md:text-3xl font-bold bg-linear-to-r from-teal-400 to-blue-400 bg-clip-text text-transparent">
                  {stat.value}
                </div>
