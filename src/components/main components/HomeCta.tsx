export default function CtaSection1() {
  return (
    <div className="bg-linear-to-b from-white to-gray-50 dark:from-black dark:to-gray-900">
      <div className="mx-auto max-w-7xl py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="relative isolate overflow-hidden bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 px-6 pt-12 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-16 lg:px-24 lg:pt-16 lg:pb-20">
